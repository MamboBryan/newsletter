...
AI can now be deemed ubiquitous. It is so everywhere that we might as well be living in a Cyberpunk 🤖 of sorts. We can even barely think of anything that does not at least run on AI. You 🫵 know that and so do we. That is why we had [Andrés-Leonardo Martínez-Ortiz](https://www.linkedin.com/in/almo/) [we prefer to call him Almo 😄...] all the way from Google talk to us about AI and how big it has gotten since its adoption...
...
Yes, we had another AI session 🙂. You saw this coming, did you not 😂? As if sponsoring this meetup was not enough, [Snapp Mobile](https://www.snappmobile.io/) had [Enrique López-Mañas](https://www.linkedin.com/in/eenriquelopez/) [CTO] who took the audience through the process of verifying LLM Input and Output for Developers. While there is no denying that AI is rapidly evolving, we also cannot overlook the vulnerabilities 🐞 that accompany that. Enrique helped mitigate this issue by offering his insights on how to effectively control what your LLM receives and produces...

## AI Agents in Copilot

![AI Agents in Copilot](../assets/AI%20Agents%20in%20Copilot.webp)

Do you have an Agent 🤓? No, we are not talking about M-PESA 💰 Agents or something. We are referring to the ones that make you believe that you are Iron Man. Yet again, Snapp Mobile had [Bryan Dollery](https://www.linkedin.com/in/bryandollery/) deliver the final session on AI Agents in Copilot. In his talk, he talked [pun intended] about how modern intelligent 🧠 AI Agents are reshaping Developer Productivity...
...
"Hey Fam! 👋 BIG ANNOUNCEMENT 🎉

We're just 20 DAYS AWAY from the most anticipated tech event of the year - droidcon Kenya x FlutterconKE 2025! Can you believe it?! 🤯 Here's the deal:
...
**What Beats Rock?** is a playful, AI-powered game built by [Donald Isoe](https://x.com/don_okara) that transforms the classic rock 🪨-paper 📄-scissors ✂️ mechanic into an infinite loop of logic, creativity, and fun. Users are prompted with a question like:
...
👉 Check it out here: [https://play.google.com/store/apps/details?id=ke.don.what_beats_rock&pcampaignid=web_share](https://play.google.com/store/apps/details?id=ke.don.what_beats_rock&pcampaignid=web_share)
